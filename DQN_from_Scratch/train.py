"""
The complete DQN learning cycle, matching the doc's 10 steps exactly:
...
RESULT_PATH = "./DQN_from_Scratch/results"
CHECKPOINT_PATH = "./DQN_from_Scratch/checkpoints"
...
def train(
    ...
    history = []  # list of dicts: episode, reward, length, epsilon, avg_loss
    ...
    for episode in range(1, n_episodes + 1):
        ...
        for step in range(max_steps):
            ...
            # Steps 5-10: sample + learn, only once we have enough data
    ...
    # Save training history to CSV (doc section 12/13).
    ...
    # Save a checkpoint.
    ckpt_path = os.path.join(checkpoints_dir, "dqn_cartpole.pt")
