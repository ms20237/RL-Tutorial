"""
Same idea as Project 1: plot the reward curve, print the learned policy,
and walk the greedy path.
"""
import os
import numpy as np
...
PLOT_PATH = "./SARSA_from_scratch/plots"
...
def plot_rewards(episode_rewards, window=20, plot_path=PLOT_PATH):
    ...
    plt.title("SARSA on GridWorld: reward over time")
    plt.legend()
    plt.tight_layout()
